...
@DisplayName("Test YouTubeVideoViewComparator class")
@TestMethodOrder(MethodOrderer.OrderAnnotation.class)
class YouTubeVideoViewComparatorTest {
    private static YouTubeDataParser dataParser;
    private YouTubeVideoViewComparator comparator;
    ...
    @Test
    @Order(1)
    @DisplayName("Test 1st File, Comparing Videos by Views (Ascending order)")
    ...
    @Test
    @Order(2)
    @DisplayName("Test 2nd File, Comparing Videos by Views (Ascending order)")
    ...
    @Test
    @Order(3)
    @DisplayName("Test 3rd File, Comparing Videos by Views (Ascending order)")
    ...
    @Test
    @Order(4)
    @DisplayName("Test 4th File, Comparing Videos by Views (Ascending order)")
    ...
    @Test
    @Order(5)
    @DisplayName("Test 5th File, Comparing Videos by Views (Ascending order)")
    ...
    @Test
    @Order(6)
    @DisplayName("Test 6th File, Comparing Videos by Views (Ascending order)")
