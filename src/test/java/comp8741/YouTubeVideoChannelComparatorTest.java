...
@DisplayName("Test YouTubeVideoChannelComparator class")
@TestMethodOrder(MethodOrderer.OrderAnnotation.class)
class YouTubeVideoChannelComparatorTest {

    private static YouTubeDataParser dataParser;
    private YouTubeVideoChannelComparator comparator;
    ...
    @Test
    @Order(1)
    @DisplayName("Test 1st File, Comparing Videos by Description (Alphabetical order)")
    ...
    @Test
    @Order(2)
    @DisplayName("Test 2nd File, Comparing Videos by Description (Alphabetical order)")
    void compareSecondFileData() {
        ...
        assertAll(
                ...
                () -> assertEquals(video2.getId(), "UCEh4n8OFGogkF9Giv-jUdOg"),
                () -> assertEquals(video2.getChannel(), "Ai Plot"),
                () -> assertEquals(video2.getTitle(), "This man can Respawn"),
                () -> assertEquals(video2.getDate(), "04-09-2024 20:57:23"),
                () -> assertEquals(video2.getViewCount(), 8523808),
                () -> assertEquals(video2.getLikeCount(), 539195),
                () -> assertEquals(video2.getDislikeCount(), 0),
                () -> assertEquals(video2.getFavoriteCount(), 0),
                () -> assertEquals(video2.getCommentCount(), 707)
        );
    }

    @Test
    @Order(3)
    @DisplayName("Test 3rd File, Comparing Videos by Description (Alphabetical order)")
    ...
    @Test
    @Order(4)
    @DisplayName("Test 4th File, Comparing Videos by Description (Alphabetical order)")
    ...
    @Test
    @Order(5)
    @DisplayName("Test 5th File, Comparing Videos by Description (Alphabetical order)")
    void compareFifthFileData() {
        ...
        assertAll(
                ...
                () -> assertEquals(video5.getId(), "UC5gki32EO6PN_lhl46G1q4w"),
                () -> assertEquals(video5.getChannel(), "CNN News"),
                () -> assertEquals(video5.getTitle(), "Quisque varius tellus risus"),
                () -> assertEquals(video5.getDate(), "02-05-2016 15:30:09"),
                () -> assertEquals(video5.getViewCount(), 72127),
                () -> assertEquals(video5.getLikeCount(), 54),
                () -> assertEquals(video5.getDislikeCount(), 112),
                () -> assertEquals(video5.getFavoriteCount(), 0),
                () -> assertEquals(video5.getCommentCount(), 131)
        );
    }

    @Test
    @Order(6)
    @DisplayName("Test 6th File, Comparing Videos by Description (Alphabetical order)")
