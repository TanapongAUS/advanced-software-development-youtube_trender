...
@DisplayName("Test YouTubeVideoLikeComparator class")
@TestMethodOrder(MethodOrderer.OrderAnnotation.class)
class YouTubeVideoLikeComparatorTest {
    private static YouTubeDataParser dataParser;
    private YouTubeVideoLikeComparator comparator;
    ...
    @Test
    @Order(1)
    @DisplayName("Test 1st File, Comparing Videos by Likes (Ascending order)")
    ...
    @Test
    @Order(2)
    @DisplayName("Test 2nd File, Comparing Videos by Likes (Ascending order)")
    void compareSecondFileData() {
        ...
        assertAll(
                ...
                () -> assertEquals(video2.getId(), "UCdTQfOZ4xB-A0lm2QzM1NVQ"),
                () -> assertEquals(video2.getChannel(), "Funniest YT Clips"),
                () -> assertEquals(video2.getTitle(), "Bro Felt Bad 🤣🤣🤣 #kjsmooth #funnnymoments #funniestytclips #shorts"),
                () -> assertEquals(video2.getDate(), "04-09-2024 16:00:15"),
                () -> assertEquals(video2.getViewCount(), 9084513),
                () -> assertEquals(video2.getLikeCount(), 0),
                () -> assertEquals(video2.getDislikeCount(), 0),
                () -> assertEquals(video2.getFavoriteCount(), 0),
                () -> assertEquals(video2.getCommentCount(), 4541)
        );
    }

    @Test
    @Order(3)
    @DisplayName("Test 3rd File, Comparing Videos by Likes (Ascending order)")
    ...
    @Test
    @Order(4)
    @DisplayName("Test 4th File, Comparing Videos by Likes (Ascending order)")
    ...
    @Test
    @Order(5)
    @DisplayName("Test 5th File, Comparing Videos by Likes (Ascending order)")
    ...
    @Test
    @Order(6)
    @DisplayName("Test 6th File, Comparing Videos by Likes (Ascending order)")
