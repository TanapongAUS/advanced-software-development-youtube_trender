...
@DisplayName("Test YouTubeVideoFavoriteComparator class")
@TestMethodOrder(MethodOrderer.OrderAnnotation.class)
class YouTubeVideoFavoriteComparatorTest {
    private static YouTubeDataParser dataParser;
    private YouTubeVideoFavoriteComparator comparator;
    ...
    @Test
    @Order(1)
    @DisplayName("Test 1st File, Comparing Videos by Favorites (Ascending order)")
    ...
    @Test
    @Order(2)
    @DisplayName("Test 2nd File, Comparing Videos by Favorites (Ascending order)")
    ...
    @Test
    @Order(3)
    @DisplayName("Test 3rd File, Comparing Videos by Favorites (Ascending order)")
    void compareThirdFileData() {
        ...
        assertAll(
                ...
                () -> assertEquals(video3.getId(), "UCehf4850q1L3ng7s7L54ATA"),
                () -> assertEquals(video3.getChannel(), "Sean Naber"),
                () -> assertEquals(video3.getTitle(), "Guy cuts down tree, but there's a surprise inside"),
                () -> assertEquals(video3.getDate(), "20-04-2016 23:15:17"),
                () -> assertEquals(video3.getViewCount(), 14187775),
                () -> assertEquals(video3.getLikeCount(), 28745),
                () -> assertEquals(video3.getDislikeCount(), 4499),
                () -> assertEquals(video3.getFavoriteCount(), 0),
                () -> assertEquals(video3.getCommentCount(), 11756)
        );
    }

    @Test
    @Order(4)
    @DisplayName("Test 4th File, Comparing Videos by Favorites (Ascending order)")
    ...
    @Test
    @Order(5)
    @DisplayName("Test 5th File, Comparing Videos by Favorites (Ascending order)")
    ...
    @Test
    @Order(6)
    @DisplayName("Test 6th File, Comparing Videos by Favorites (Ascending order)")
